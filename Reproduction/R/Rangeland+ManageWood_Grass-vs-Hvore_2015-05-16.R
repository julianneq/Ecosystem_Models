...
dt=1
#eps = sigma*rnorm(nt)
#write(eps, file="epsilon2_grass.txt", ncolumns=1)
eps = scan("epsilon2_grass.txt")
...
points(Hvec,Wmean[,3],type='b',lwd=2,pch=19,col='black')

# write output to test against Python code
write.table(Gmean,"avg_grass.txt")
write.table(Wmean,"avg_wood.txt")
