 ...
 */
void BORG_Algorithm_set_max_window_size(BORG_Algorithm algorithm, int maxWindowSize);
 ...
 */
void BORG_Algorithm_set_probability_mode(BORG_Algorithm algorithm, BORG_Probabilities probilityMode);
