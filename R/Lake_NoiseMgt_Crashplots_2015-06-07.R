...
# Set up random noise vector
#eps = sigma*rnorm(nt)
#write(eps, file="epsilon2_lake.txt", ncolumns=1) # write output to verify with Python
eps = scan("epsilon2_lake.txt") # read in output to verify with Python
...
# write output to verify with Python
write.table(Pctoligo,"pct_oligo.txt")
